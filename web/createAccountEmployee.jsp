<%-- 
    ...
    Created on : Nov 5, 2024, 2:01:18 PM
...
<html>
    <head>
        ...
        <title>Office Pro | Create Employee Account</title>
    ...
    <form action="EmployeeCreateAccount" method="post">
        ...
        <div id="mainDiv">
            ...
            <div class="form-group">
                ...
                <input type="text" id="empID" name="empID" placeholder="4 digit ID" required>
            </div>
